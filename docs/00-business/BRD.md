...
| BR-11 | Where compliance record-keeping pays the farmer back, the system must capture what the claim requires at the moment of the activity | The diesel refund is the clearest case: a five- or six-figure annual entitlement routinely under-claimed because the logbook does not exist. Records reconstructed in June fail the audit. [legal-compliance.md §5.1](legal-compliance.md) |
| BR-12 | The system may show a farmer the prices that decide their year, but must never tell them what to do about those prices | Market information is a daily reason to open the app. Advice on a financial product is FAIS-licensed and we are not an FSP. The line is legal, not editorial. [legal-compliance.md §5.2](legal-compliance.md) |
| BR-13 | Work is delegated down a recorded chain — owner to manager to worker — and the right to **administer** a user is separate from the right to see their **wages, identity, or health** | Delegation is what lets an owner stop being the bottleneck. Conflating it with financial and health access is how a manager ends up reading a sick note. [legal-compliance.md §1.3](legal-compliance.md) |
| BR-14 | A worker can see their own records, raise a grievance in confidence, and summon help — and cannot be continuously tracked | Workers are the least-powerful data subjects here. SIZA requires a confidential grievance mechanism; POPIA minimality forecloses continuous location. The product that proves a farm treats people properly cannot itself surveil them. [ADR-0010](../03-architecture/adr/ADR-0010-worker-monitoring.md) |
