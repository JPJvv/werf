...
const en = {
  ...
  'notSent.kind.mobMove': 'A group move for',
  'notSent.kind.feed': 'Feed for',
  ...
  'notSent.kind.inventoryItem': 'A stock item',
  'notSent.kind.inventoryLot': 'A stock lot',
  'notSent.kind.inventoryMovement': 'A stock movement',
  ...
  // Splitting a block (FR-202). A camp is never split here — gated the same way planting is.
  'land.split.action': 'Split this block',
  'land.split.into': 'Split into:',
  'land.split.title': 'Split a block',
  'land.split.noBlocks': 'No blocks yet. Add your first one — it saves with no signal.',
  'land.split.which': 'Which block?',
  'land.split.keptWarning':
    'The old block is kept in the record, with everything ever filed against it. Splitting only adds new ground — it changes nothing about what already happened here.',
  'land.split.child': 'Block',
  'land.split.remove': 'Remove',
  'land.split.codeBlank': 'Give this block a name or number.',
  'land.split.codeExisting': 'This farm already has a block with that name.',
  'land.split.codeDuplicate': 'Two of these blocks have the same name.',
  'land.split.addAnother': 'Add another block',
  'land.split.save': 'Save the split',
  'land.split.saved': 'Split — your work is saved. New blocks:',
  'land.split.back': 'Back to land',
  ...
  // Fertiliser (FR-206). Same "camps ask neither" gating as planting above.
  'crops.fertilise.none': 'no fertiliser recorded',
  'crops.fertilise.applied': 'applied',
  'crops.fertilise.record': 'Record fertiliser',
  'crops.fertilise.title': 'Record a fertiliser application',
  'crops.fertilise.noBlocks': 'No blocks yet. Add your first one — it saves with no signal.',
  'crops.fertilise.which': 'Which block?',
  'crops.fertilise.product': 'Product',
  'crops.fertilise.method': 'How was it applied?',
  'crops.fertilise.method.broadcast': 'Broadcast',
  'crops.fertilise.method.band': 'Band',
  'crops.fertilise.method.fertigation': 'Fertigation',
  'crops.fertilise.method.foliar': 'Foliar',
  'crops.fertilise.rate': 'Rate (optional)',
  'crops.fertilise.rateUnit': 'Unit',
  'crops.fertilise.rateUnitExample': 'e.g. kg/ha',
  'crops.fertilise.rateBad': 'Give both a number and a unit, or leave rate blank.',
  'crops.fertilise.operator': 'Applied by (optional)',
  'crops.fertilise.day': 'Day applied',
  ...
  'crops.spray.operator': 'Applied by (optional)',
  ...
  'crops.sprays.allBlocks': 'All blocks',
  'crops.sprays.filterFrom': 'From',
  'crops.sprays.filterTo': 'To',
  ...
  'animals.moveGroup': 'Move a group',
  'animals.feed': 'Feed',
  // Moving a whole GROUP to another camp (FR-151) — one mob, one destination, per save.
  'moveMob.title': 'Move a group',
  'moveMob.which': 'Which group?',
  'moveMob.pickDestination': 'Pick a camp',
  'moveMob.save': 'Move them',
  'moveMob.saved': 'moved — your work is saved',
  'moveMob.back': 'Back to animals',
  'moveMob.empty': 'No groups to move yet.',

  'feed.title': 'Record feed',
  'feed.which': 'Which group?',
  'feed.orCamp': 'Or a camp with no group',
  'feed.pickCamp': 'Choose a camp',
  'feed.herd': 'Which herd?',
  'feed.pickHerd': 'Choose a herd',
  'feed.lot': 'From stock',
  'feed.pickLot': 'Choose feed',
  'feed.quantity': 'Quantity',
  'feed.costEstimate': 'Estimated cost',
  'feed.day': 'Day',
  'feed.save': 'Save',
  'feed.saved': 'fed — your work is saved',
  'feed.back': 'Back to animals',
  'feed.empty': 'No groups or camps to feed yet.',
  'feed.noLots': 'No feed in stock yet.',
  'feed.receiveStock': 'Receive stock',
  ...
  // Inventory (Phase 4e, FR-501) — stock on hand for chemicals, fertiliser, feed and medicine. Farm-
  // level, not enterprise-level: a mixed farm's shed is one shed, so this has no tile of its own —
  // reached from home as a secondary link, the same posture rainfall's link takes.
  'inventory.link': 'Stock on hand',
  'inventory.title': 'Stock',
  'inventory.empty': 'No stock recorded yet.',
  'inventory.batch': 'Batch',
  'inventory.expiry': 'Expires',
  'inventory.category.chemical': 'Chemical',
  'inventory.category.fertiliser': 'Fertiliser',
  'inventory.category.feed': 'Feed',
  'inventory.category.medicine': 'Medicine',
  'inventory.receive.action': 'Receive stock',
  'inventory.receive.title': 'Receive stock',
  'inventory.receive.item': 'What arrived',
  'inventory.receive.category': 'Kind',
  'inventory.receive.unit': 'Unit',
  'inventory.receive.unitExample': 'e.g. kg, L, bag',
  'inventory.receive.batch': 'Batch (optional)',
  'inventory.receive.expiry': 'Expires (optional)',
  'inventory.receive.location': 'Where it is stored (optional)',
  'inventory.receive.quantity': 'How much arrived',
  'inventory.receive.cost': 'What it cost (optional)',
  'inventory.receive.costBad': 'That does not look like an amount in rands.',
  'inventory.receive.day': 'When did it arrive?',
...
const af: Record<TranslationKey, string> = {
  ...
  'notSent.kind.mobMove': '’n Groepskuif vir',
  'notSent.kind.feed': 'Voer vir',
  ...
  'notSent.kind.inventoryItem': '’n Voorraaditem',
  'notSent.kind.inventoryLot': '’n Voorraadlot',
  'notSent.kind.inventoryMovement': '’n Voorraadbeweging',
  'notSent.why.tagTaken':
  ...
  'land.split.action': 'Verdeel hierdie blok',
  'land.split.into': 'Verdeel in:',
  'land.split.title': 'Verdeel ’n blok',
  'land.split.noBlocks': 'Nog geen blokke nie. Voeg jou eerste een by — dit stoor sonder sein.',
  'land.split.which': 'Watter blok?',
  'land.split.keptWarning':
    'Die ou blok bly in die rekord, met alles wat ooit daarteen aangeteken is. Verdeling voeg net nuwe grond by — dit verander niks aan wat hier alreeds gebeur het nie.',
  'land.split.child': 'Blok',
  'land.split.remove': 'Verwyder',
  'land.split.codeBlank': 'Gee hierdie blok ’n naam of nommer.',
  'land.split.codeExisting': 'Hierdie plaas het reeds ’n blok met daardie naam.',
  'land.split.codeDuplicate': 'Twee van hierdie blokke het dieselfde naam.',
  'land.split.addAnother': 'Voeg nog ’n blok by',
  'land.split.save': 'Stoor die verdeling',
  'land.split.saved': 'Verdeel — jou werk is gestoor. Nuwe blokke:',
  'land.split.back': 'Terug na grond',
  ...
  'crops.fertilise.none': 'geen bemesting aangeteken nie',
  'crops.fertilise.applied': 'toegedien',
  'crops.fertilise.record': 'Teken bemesting aan',
  'crops.fertilise.title': 'Teken ’n bemestingstoediening aan',
  'crops.fertilise.noBlocks':
    'Nog geen blokke nie. Voeg jou eerste een by — dit stoor sonder sein.',
  'crops.fertilise.which': 'Watter blok?',
  'crops.fertilise.product': 'Produk',
  'crops.fertilise.method': 'Hoe is dit toegedien?',
  'crops.fertilise.method.broadcast': 'Uitgestrooi',
  'crops.fertilise.method.band': 'Bandtoediening',
  'crops.fertilise.method.fertigation': 'Fertigasie',
  'crops.fertilise.method.foliar': 'Blaartoediening',
  'crops.fertilise.rate': 'Dosis (opsioneel)',
  'crops.fertilise.rateUnit': 'Eenheid',
  'crops.fertilise.rateUnitExample': 'bv. kg/ha',
  'crops.fertilise.rateBad': 'Gee beide ’n getal en ’n eenheid, of los dosis leeg.',
  'crops.fertilise.operator': 'Toegedien deur (opsioneel)',
  'crops.fertilise.day': 'Dag toegedien',
  ...
  'crops.sprays.allBlocks': 'Alle blokke',
  'crops.sprays.filterFrom': 'Vanaf',
  'crops.sprays.filterTo': 'Tot',
  ...
  'animals.moveGroup': 'Skuif ’n groep',
  'animals.feed': 'Voer',
  'moveMob.title': 'Skuif ’n groep',
  'moveMob.which': 'Watter groep?',
  'moveMob.pickDestination': 'Kies ’n kamp',
  'moveMob.save': 'Skuif hulle',
  'moveMob.saved': 'geskuif — jou werk is gestoor',
  'moveMob.back': 'Terug na diere',
  'moveMob.empty': 'Nog geen groepe om te skuif nie.',

  'feed.title': 'Teken voer aan',
  'feed.which': 'Watter groep?',
  'feed.orCamp': 'Of ’n kamp met geen groep nie',
  'feed.pickCamp': 'Kies ’n kamp',
  'feed.herd': 'Watter trop?',
  'feed.pickHerd': 'Kies ’n trop',
  'feed.lot': 'Uit voorraad',
  'feed.pickLot': 'Kies voer',
  'feed.quantity': 'Hoeveelheid',
  'feed.costEstimate': 'Geskatte koste',
  'feed.day': 'Dag',
  'feed.save': 'Stoor',
  'feed.saved': 'gevoer — jou werk is gestoor',
  'feed.back': 'Terug na diere',
  'feed.empty': 'Nog geen groepe of kampe om te voer nie.',
  'feed.noLots': 'Nog geen voer in voorraad nie.',
  'feed.receiveStock': 'Ontvang voorraad',
  ...
  'inventory.link': 'Voorraad op hande',
  'inventory.title': 'Voorraad',
  'inventory.empty': 'Nog geen voorraad aangeteken nie.',
  'inventory.batch': 'Lot',
  'inventory.expiry': 'Verval',
  'inventory.category.chemical': 'Chemikalie',
  'inventory.category.fertiliser': 'Kunsmis',
  'inventory.category.feed': 'Voer',
  'inventory.category.medicine': 'Medisyne',
  'inventory.receive.action': 'Ontvang voorraad',
  'inventory.receive.title': 'Ontvang voorraad',
  'inventory.receive.item': 'Wat aangekom het',
  'inventory.receive.category': 'Soort',
  'inventory.receive.unit': 'Eenheid',
  'inventory.receive.unitExample': 'bv. kg, L, sak',
  'inventory.receive.batch': 'Lot (opsioneel)',
  'inventory.receive.expiry': 'Verval (opsioneel)',
  'inventory.receive.location': 'Waar dit gebêre word (opsioneel)',
  'inventory.receive.quantity': 'Hoeveel het aangekom',
  'inventory.receive.cost': 'Wat dit gekos het (opsioneel)',
  'inventory.receive.costBad': 'Dit lyk nie na ’n bedrag in rand nie.',
  'inventory.receive.day': 'Wanneer het dit aangekom?',
