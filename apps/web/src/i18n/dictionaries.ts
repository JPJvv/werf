...
const en = {
  ...
  // Crops module (FR-203). A camp is never planted — these only ever show on a block's row.
  'crops.notPlanted': 'not planted yet',
  'crops.planted': 'planted',
  'crops.recordPlanting': 'Record a planting',
  'crops.plant.title': 'Record a planting',
  'crops.plant.noBlocks': 'No blocks yet. Add your first one — it saves with no signal.',
  'crops.plant.which': 'Which block?',
  'crops.plant.crop': 'Crop',
  'crops.plant.cultivar': 'Cultivar (optional)',
  'crops.plant.density': 'Density (optional)',
  'crops.plant.densityUnit': 'Unit',
  'crops.plant.densityUnitExample': 'e.g. plants/ha',
  'crops.plant.densityBad': 'Give both a number and a unit, or leave density blank.',
  'crops.plant.seedSource': 'Seed source (optional)',
  'crops.plant.expectedHarvest': 'Expected harvest (optional)',
  'crops.plant.day': 'Day planted',
  'crops.plant.save': 'Save planting',
  'crops.plant.saved': 'saved — your work is saved',
  'crops.plant.back': 'Back to land',
...
const af: Record<TranslationKey, string> = {
  ...
  'crops.notPlanted': 'nog nie geplant nie',
  'crops.planted': 'geplant',
  'crops.recordPlanting': 'Teken ’n aanplanting aan',
  'crops.plant.title': 'Teken ’n aanplanting aan',
  'crops.plant.noBlocks': 'Nog geen blokke nie. Voeg jou eerste een by — dit stoor sonder sein.',
  'crops.plant.which': 'Watter blok?',
  'crops.plant.crop': 'Gewas',
  'crops.plant.cultivar': 'Kultivar (opsioneel)',
  'crops.plant.density': 'Digtheid (opsioneel)',
  'crops.plant.densityUnit': 'Eenheid',
  'crops.plant.densityUnitExample': 'bv. plante/ha',
  'crops.plant.densityBad': 'Gee beide ’n getal en ’n eenheid, of los digtheid leeg.',
  'crops.plant.seedSource': 'Saadbron (opsioneel)',
  'crops.plant.expectedHarvest': 'Verwagte oes (opsioneel)',
  'crops.plant.day': 'Dag geplant',
  'crops.plant.save': 'Stoor aanplanting',
  'crops.plant.saved': 'gestoor — jou werk is gestoor',
  'crops.plant.back': 'Terug na grond',
  'animals.title': 'Diere',
  'animals.head': 'stuks',
